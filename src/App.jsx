      ...
      <div className=''>
          ...
          <div className='text-center flex flex-col items-center  md:flex-row-reverse md:justify-between md:items-center md:text-left md:gap-12 lg:gap-20'>
            <div
              ...
              <div
                ...
                <div className='rounded-full bg-[#EDF7FA] absolute w-[180px] h-[180px] md:w-[270px] md:h-[270px] bottom-0 left-[4.3%] md:left-2 md:bottom-0'></div>
                <img
                  className='rounded-full absolute w-[180px] h-[180px] md:w-[270px] md:h-[270px] object-cover object-position-y-top border-4 border-white shadow-md'
                  style={{ objectPosition: '10% 5%' }}
                  src='/img/desta2.jpg'
                  alt='profile'
                />
              </div>
        ...
        <section
          ...
          <div className='flex space-x-10 pt-4'>
            <a
              href='https://github.com/Destaanugra1'
              className='text-dark hover:text-primary w-5 h-5 md:w-8 md:h-8'>
              <GithubIcon />
            </a>
            <a
              href='instagram.com/destaanugrahpr/'
              className='text-dark hover:text-primary w-5 h-5 md:w-8 md:h-8'>
              <InstagramIcon />
            </a>
            <a
              href='https://www.linkedin.com/in/desta-anugra-pratama-733b18317/'
              className='text-dark hover:text-primary w-5 h-5 md:w-8 md:h-8'>
              <LinkedinIcon />
            </a>
          </div>
